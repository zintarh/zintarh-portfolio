...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "women in blockchain",
    "accomplished women in blockchain",
    "accomplished women in web3",
    "accomplished women in tech",
    "accomplished women in development",
    "accomplished women in engineering",
    "accomplished women in software development",
    "accomplished women in software engineering",
    "accomplished women in software development engineering",
    "accomplished women in software engineering",
    "accomplished women in software development engineering",
    "accomplished women in software engineering",
    "accomplished women in software development engineering",
